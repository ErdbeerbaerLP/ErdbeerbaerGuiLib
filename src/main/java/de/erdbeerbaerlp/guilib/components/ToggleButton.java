...
public class ToggleButton extends Button {
	...
	public ToggleButton(int xPos, int yPos, ResourceLocation icon) {
	...
	public void draw(int mouseX, int mouseY, float partial) {
        if (this.visible)
        {
            ...
            this.drawCenteredString(mc.fontRenderer, buttonText +((drawType == DrawType.STRING || drawType == DrawType.BOTH)?(this.value?"ON":"OFF"):""), bx + mwidth / 2, this.y + (this.height - 8) / 2, color);
        }
